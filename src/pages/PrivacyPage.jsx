...
export default function PrivacyPage() {
  ...
  return (
    <main className="min-h-screen bg-slate-900 relative overflow-hidden">
      {/* Watermarks */}
      <span className="absolute top-20 -right-6 text-[14rem] font-black text-white/[.02] select-none pointer-events-none -rotate-12" aria-hidden>
        私
      </span>
      <span className="absolute bottom-16 -left-8 text-[12rem] font-black text-white/[.02] select-none pointer-events-none rotate-6" aria-hidden>
        守
      </span>
      ...
      <div className="relative z-10 pt-20 md:pt-28 pb-8 md:pb-12 px-4 md:px-6 text-center">
        ...
        <p className="text-xs md:text-sm text-white/30">
          {t('privacy.lastUpdated')}: 2026-01-01
        </p>
      </div>
